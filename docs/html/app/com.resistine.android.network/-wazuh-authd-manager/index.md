...
[androidJvm]\
class [WazuhAuthdManager](index.md)(socketFactory: [SSLSocketFactory](https://developer.android.com/reference/kotlin/javax/net/ssl/SSLSocketFactory.html) = unauthenticatedTlsSocketFactory)

Manager responsible for automatic agent registration via the Wazuh 'authd' service.

It communicates over an encrypted TLS socket to request a unique Agent ID and Key. The manager certificate is intentionally not authenticated to match the default Wazuh desktop enrollment behavior.

## Constructors

| | |
|---|---|
| [WazuhAuthdManager](-wazuh-authd-manager.md) | [androidJvm]<br>constructor(socketFactory: [SSLSocketFactory](https://developer.android.com/reference/kotlin/javax/net/ssl/SSLSocketFactory.html) = unauthenticatedTlsSocketFactory) |
