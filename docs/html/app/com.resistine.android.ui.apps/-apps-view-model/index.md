...
| [integrityState](integrity-state.md) | [androidJvm]<br>val [integrityState](integrity-state.md): [LiveData](https://developer.android.com/reference/kotlin/androidx/lifecycle/LiveData.html)&lt;[IntegrityUiState](../../com.resistine.android.ui.integrity/-integrity-ui-state/index.md)&gt; |
...
| [uiState](ui-state.md) | [androidJvm]<br>val [uiState](ui-state.md): [LiveData](https://developer.android.com/reference/kotlin/androidx/lifecycle/LiveData.html)&lt;[AppsUiState](../-apps-ui-state/index.md)&gt; |
...
| [refreshCapabilityState](refresh-capability-state.md) | [androidJvm]<br>fun [refreshCapabilityState](refresh-capability-state.md)() |
| [runIntegrityCheck](run-integrity-check.md) | [androidJvm]<br>fun [runIntegrityCheck](run-integrity-check.md)() |
...
| [showIntegrityRemediation](show-integrity-remediation.md) | [androidJvm]<br>suspend fun [showIntegrityRemediation](show-integrity-remediation.md)(activity: [Activity](https://developer.android.com/reference/kotlin/android/app/Activity.html)): [Result](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-result/index.html)&lt;[Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html)&gt; |
