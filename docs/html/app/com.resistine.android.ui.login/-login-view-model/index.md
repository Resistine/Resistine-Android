...
| Name | Summary |
|---|---|
| [email](email.md) | [androidJvm]<br>val [email](email.md): [MutableLiveData](https://developer.android.com/reference/kotlin/androidx/lifecycle/MutableLiveData.html)&lt;[String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)?&gt; |
...
| [uiState](ui-state.md) | [androidJvm]<br>val [uiState](ui-state.md): [LiveData](https://developer.android.com/reference/kotlin/androidx/lifecycle/LiveData.html)&lt;[LoginUiState](../-login-ui-state/index.md)&gt; |
...
| [clearEmail](clear-email.md) | [androidJvm]<br>fun [clearEmail](clear-email.md)() |
| [consumeError](consume-error.md) | [androidJvm]<br>fun [consumeError](consume-error.md)(): [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)? |
| [consumeLoginSuccess](consume-login-success.md) | [androidJvm]<br>fun [consumeLoginSuccess](consume-login-success.md)(): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) |
| [consumeOtpSent](consume-otp-sent.md) | [androidJvm]<br>fun [consumeOtpSent](consume-otp-sent.md)(): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) |
